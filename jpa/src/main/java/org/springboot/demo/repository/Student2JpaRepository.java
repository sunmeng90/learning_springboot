...
public interface Student2JpaRepository extends JpaBaseRepository<Student, Integer> {
    ...
    @Query("select distinct stu from Student stu " +
            "join fetch stu.courses cs join fetch cs.course c " +
            "left join fetch cs.books b " +
            "where stu.audit.effectiveEndDate = :" + YEAR_9999 + " " +
            "and cs.audit.effectiveEndDate = :" + YEAR_9999 + " " +
            "and c.audit.effectiveEndDate = :" + YEAR_9999 + " " +
            "and b.audit.effectiveEndDate = :" + YEAR_9999)
